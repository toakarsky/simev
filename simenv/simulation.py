...
class Simulation:
    ...
    def runMenuScreen(self):
        ...
        titleText = titleFont.render('SimEnv', True, (255, 255, 255))
        titleTextShadow = titleFont.render('SimEnv', True, (128, 128, 128))
        titleTextPos = (WINDOW_SIZE[0] / 2 - titleText.get_width() / 2, 25)
        titleTextShadowPos = (titleTextPos[0] + 2, titleTextPos[1] + 2)
